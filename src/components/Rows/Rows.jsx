...
const Rows = () => {
  ...
  return (
    <div className=" relative max-w-[1215px] mx-auto">
      ...
      <div className="w-full flex items-center overflow-hidden gap-5 justify-between col-span-12 md:col-span-6 lg:col-span-3 h-[400px] bg-black/90 rounded-xl bg-gradient-to-l from-gray-800 via-gray-700 to-gray-600  ">
