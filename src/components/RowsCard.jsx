  ...
  return (
    <div className=" w-44 md:w-52 ">
      <img
        src={img}
        alt="Shoes"
        className="rounded-[25px] h-10 border-2 w-full overflow-hidden "
      />

      <div className=" flex flex-col mt-3 items-center text-center">
        <h2 className="text-[12px] md:text-[16px] font-semibold mb-2 text-white">
          Refreshing Mint
        </h2>
        <p className="text-[12px] md:text-[16px] text-white mb-2">30,000 MMK</p>
        <span className=" flex items-center gap-1 text-[12px] md:text-[16px] text-yellow-500">
          <BsStarFill size={10} />
          600 Points
        </span>
      </div>
